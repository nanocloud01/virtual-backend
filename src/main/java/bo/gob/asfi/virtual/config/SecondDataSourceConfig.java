package bo.gob.asfi.virtual.config;
...
@EnableJpaRepositories(
		basePackages = "bo.gob.asfi.virtual.modelfoo.repositories",
...
public class SecondDataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean ordersEntityManagerFactory()
    {
        ...
        factory.setPackagesToScan(new String[]{"bo.gob.asfi.virtual.modelfoo.entities"});
